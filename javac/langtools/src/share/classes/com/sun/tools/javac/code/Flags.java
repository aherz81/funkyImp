...
public class Flags {
    ...
    public static EnumSet<Flag> asFlagSet(long mask) {
        ...
        if ((mask&LOOP) != 0) flags.add(Flag.LOOP);
        if ((mask&ATOMIC) != 0) flags.add(Flag.ATOMIC);
        if ((mask&PACKED) != 0) flags.add(Flag.PACKED);
        if ((mask&LINEARREAD) != 0) flags.add(Flag.LINEARREAD);
        ...
        if ((mask&EXPORT) != 0) flags.add(Flag.EXPORT);
        ...
        if ((mask&FIN) != 0) flags.add(Flag.FIN);
        if ((mask&FOUT) != 0) flags.add(Flag.FOUT);
        if ((mask&LINEAR) != 0) flags.add(Flag.LINEAR);
        if ((mask&UNSIGNED) != 0) flags.add(Flag.UNSIGNED);
        if ((mask&BLOCKING) != 0) flags.add(Flag.BLOCKING);
        return flags;
    }
    ...
    public static final int STRICTFP     = 1<<11;//shouldn't be used anymore!
    public static final int EXPORT		 = 1<<11;

    /* Flag that marks a symbol synthetic, added in classfile v49.0. */
    public static final int SYNTHETIC    = 1<<12; //shouldn't be used
     ...
     * Flag that marks a Sun proprietary class.
     */
    public static final long WHEREBLOCK = 1L<<39;

    public static final long FIN          = 1L<<40;
    public static final long FOUT         = 1L<<41; //mark as pointer
    public static final long FINOUT       = FIN|FOUT;

    public static final long LINEAR          = 1L<<42;
    public static final long BLOCKING          = 1L<<43;
    public static final long TASKLOCAL          = 1L<<44;
	public static final long IMPLICITDECL	= 1L<<45;
    public static final long SINGULAR          = 1L<<46;
    public static final long PARALLEL          = 1L<<47;
    public static final long FORCE_PARALLEL          = 1L<<48;
    public static final long WORK          = 1L<<49;
    public static final long ATOMIC         = 1L<<50;
    public static final long LOOP         = 1L<<51;
    public static final long TIME         = 1L<<52;
    public static final long UNSIGNED    = 1L<<53;
    public static final long NONBLOCKING    = 1L<<54;
    public static final long PACKED    = 1L<<55;
    public static final long LINEARREAD    = 1L<<56;
    public static final long INLINE    = 1L<<57;
//    public static final long AUTO_FINAL         = 1<<51;
    //public static final long UNIQUE          = 1L<<46;
    ...
    public static final long
        ...
        ClassFlags            = LocalClassFlags | INTERFACE | PUBLIC | ANNOTATION | LINEAR | NATIVE | SINGULAR | ATOMIC | EXPORT,
        InterfaceVarFlags     = FINAL | STATIC | PUBLIC | LINEAR | NATIVE,
        VarFlags              = AccessFlags | FINAL | STATIC |
                                VOLATILE | TRANSIENT | ENUM | LINEAR,
        ConstructorFlags      = AccessFlags,
        InterfaceMethodFlags  = ABSTRACT | PUBLIC,
        MethodFlags           = AccessFlags | ABSTRACT | STATIC |
                                SYNCHRONIZED | FINAL | STRICTFP | LOOP;
    public static final long
    ...
    public static Set<Modifier> asModifierSet(long flags) {
        ...
        if (modifiers == null) {
            ...
            if (0 != (flags & EXPORT))    modifiers.add(Modifier.EXPORT);
