...
public class TransTypes extends TreeTranslator {
    ...
    protected TransTypes(Context context) {
        ...
        overridden = new LinkedHashMap<MethodSymbol,MethodSymbol>();
    ...
    void addBridge(DiagnosticPosition pos,
        ...
        if (!hypothetical) {
            ...
            JCStatement stat = (origErasure.getReturnType().tag == VOID)
                ? make.Exec(call)
                : make.Return(coerce(call, bridgeType.getReturnType()),0);
 ...
 *************************************************************************/
    ...
    public JCTree translateTopLevelClass(JCTree cdef, TreeMaker make) {
		...
		//ALEX: we pass the generics through to the code generated which creates templates
