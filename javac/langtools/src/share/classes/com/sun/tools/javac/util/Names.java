...
//    public final Name Where;
    ...
    public final Name one_d;
    public final Name reduce;
    public final Name size;
    public final Name resize;
    public final Name split;
    public final Name Object;
    public final Name String;
    public final Name funky;
    public final Name _native;

    public final Name MemberVariables;
    ...
    public Names(Context context) {
        ...
        java_lang = fromString("funky");
        java_lang_Object = fromString("funky.Object");
        java_lang_Class = fromString("funky.Class");
        java_lang_Cloneable = fromString("funky.Cloneable");
        java_io_Serializable = fromString("java.io.Serializable");
        java_lang_Enum = fromString("funky.Enum");
...
//        Where = fromString("Where");
        ...
        MemberVariables = fromString("MemberVariables");
		reduce = fromString("reduce");
		size = fromString("size");
		resize = fromString("resize");
		split = fromString("split");
		one_d = fromString("one_d");

		Object = fromString("Object");
		String = fromString("String");
		funky = fromString("funky");
		_native = fromString("native");
    }
