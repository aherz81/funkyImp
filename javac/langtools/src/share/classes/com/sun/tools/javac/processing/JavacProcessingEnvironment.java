...
public class JavacProcessingEnvironment implements ProcessingEnvironment, Closeable {
    ...
    private Set<String> initPlatformAnnotations() {
        Set<String> platformAnnotations = new LinkedHashSet<String>();
    ...
    private Set<String> initUnmatchedProcessorOptions() {
        Set<String> unmatchedProcessorOptions = new LinkedHashSet<String>();
    ...
    private void discoverAndRunProcs(Context context,
        ...
        Map<String, TypeElement> unmatchedAnnotations =
            new LinkedHashMap<String, TypeElement>(annotationsPresent.size());
    ...
    private List<PackageSymbol> getPackageInfoFiles(List<? extends JCCompilationUnit> units) {
        ...
        for (JCCompilationUnit unit : units) {
            boolean isPkgInfo = unit.sourcefile.isNameCompatible("package-info",
                                ...
                                ||
                                unit.sourcefile.isNameCompatible("package-info",
    ...
    private static TreeScanner treeCleaner = new TreeScanner() {
            ...
            public void visitDomainDef(JCDomainDecl node) {
                node.sym = null;
                super.visitDomainDef(node);
            }
