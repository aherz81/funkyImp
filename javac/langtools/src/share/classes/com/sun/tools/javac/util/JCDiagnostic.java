...
public class JCDiagnostic implements Diagnostic<JavaFileObject> {
    ...
    public static class Factory {
        ...
        protected Factory(Context context) {
            this(JavacMessages.instance(context), "compiler", context);
            context.put(diagnosticFactoryKey, this);
        }

        /** Create a new diagnostic factory. */
        public Factory(JavacMessages messages, String prefix,Context context) {
            this.prefix = prefix;
            ...
            if(!regression)
                ...
                this.formatter = new RegressionDiagnosticFormatter(messages);
        }
