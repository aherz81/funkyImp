...
public enum OptionName {
    ...
    NOPP("-nopp"),
    ANALYSIS("-ANALYSIS"),
    NOPATHMERGE("-NOPATHMERGE"),
    NOPARALLELPATHS("-NOPARALLELPATHS"),
    FORCEGCCLEANUP("-FORCEGCCLEANUP"),
    DUMPMERGE("-DUMPMERGE"),
    LLVM("-LLVM"),
    CPP("-CPP"),
    WORK("-WORK"),
    DEPGRAPH("-DEPGRAPH"),
    USELOCALHACK("-LOCAL_HACK"),
    USEOPENCL("-useopencl"),
    SIMPLEMEMMODEL("-SIMPLE_MEM_MODEL"),
    VERIFYARRAYS("-analyzearrays"),
    RTVERIFYARRAYS("-checkarrays"),
    MPI("-MPI"),
    //only valid in combination with -MPI
    OPTIMIZERECURSION("-OPTIMIZERECURSION");
