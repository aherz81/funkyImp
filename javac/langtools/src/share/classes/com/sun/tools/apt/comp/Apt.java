...
public class Apt extends ListBuffer<Env<AttrContext>> {
    ...
    public void main(com.sun.tools.javac.util.List<JCTree.JCCompilationUnit> treeList,
        ...
        if (options.get("-print") != null) {
            ...
            AnnotationProcessor proc = (new BootstrapAPF()).getProcessorFor(new LinkedHashSet<AnnotationTypeDeclaration>(),
                                                                            trivAPE);
            proc.process();
        } else {
            // Discovery process
            ...
            if (!providers.hasNext() && productiveFactories.size() == 0) {
                ...
                Set<String> emptyStringSet = new LinkedHashSet<String>();
                emptyStringSet.add("");
                ...
                while (providers.hasNext() ) {
                    ...
                    try {
                        Set<String> matchedStrings = new LinkedHashSet<String>();
                        ...
                        if (matchedStrings.size() > 0) {
                            ...
                            // type decls
                            Set<AnnotationTypeDeclaration> atds = new LinkedHashSet<AnnotationTypeDeclaration>();
