...
public class PrintAP implements AnnotationProcessor {
    ...
    static class PrintingVisitors {
        ...
        class PrePrinting extends SimpleDeclarationVisitor {
            Map<EnumDeclaration, Integer> enumCardinality  = new LinkedHashMap<EnumDeclaration, Integer>();
            Map<EnumDeclaration, Integer> enumConstVisited = new LinkedHashMap<EnumDeclaration, Integer>();
        ...
        private void printInterfaces(AnnotationTypeDeclaration d) {
            Collection<InterfaceType> interfaces = new LinkedHashSet<InterfaceType>(d.getSuperinterfaces());
