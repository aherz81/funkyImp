...
public class Main {
     ...
     */
    Map<String,String> origOptions = new LinkedHashMap<String, String>();
    ...
    private Option[] recognizedOptions = {
        ...
        new HiddenOption("sourcefile") {
                ...
                boolean matches(String s) {
                    this.s = s;
                    return s.endsWith(".java")|| s.endsWith(".funky")|| s.endsWith(".f") ||
    ...
    public int compile(String[] args, AnnotationProcessorFactory factory) {
        ...
        try {
             ...
             * invocations.
             */
            origOptions = new LinkedHashMap<String, String>(options.size());
                    ...
                    if (matchPosition != -1) {
                        ...
                        if (op.aptOnly) {
                            ...
                            if ((options.get("-XclassesAsDecls") != null) &&
                                ...
                                if (! args[i].endsWith(".java")&&! args[i].endsWith(".funky")&&! args[i].endsWith(".f")) {
                                    newArgsLength--;
                                    args[i] = null;
                                }
                            }
