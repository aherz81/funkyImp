...
public class VisibleMemberMap {
     ...
     */
    private final Map<Object,Map<ProgramElementDoc,String>> memberNameMap = new LinkedHashMap<Object,Map<ProgramElementDoc,String>>();

    /**
     * Map of class and it's ClassMembers object.
     */
    private final Map<ClassDoc,ClassMembers> classMap = new LinkedHashMap<ClassDoc,ClassMembers>();
    ...
    private void fillMemberLevelMap(List<ProgramElementDoc> list, String level) {
        for (int i = 0; i < list.size(); i++) {
            ...
            if (memberLevelMap == null) {
                memberLevelMap = new LinkedHashMap<ProgramElementDoc,String>();
    ...
    private class ClassMember {
        ...
        public ClassMember(ProgramElementDoc programElementDoc) {
            members = new LinkedHashSet<ProgramElementDoc>();
