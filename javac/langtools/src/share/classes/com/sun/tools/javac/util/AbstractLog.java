...
public abstract class AbstractLog {
    AbstractLog(JCDiagnostic.Factory diags) {
        this.diags = diags;
        sourceMap = new LinkedHashMap<JavaFileObject, DiagnosticSource>();
    }
    ...
    public void errorMultiline(String key, Object ... args) {
        reportAlways(diags.error(source, null, key, args));
    }
    ...
    protected abstract void reportAlways(JCDiagnostic diagnostic);
