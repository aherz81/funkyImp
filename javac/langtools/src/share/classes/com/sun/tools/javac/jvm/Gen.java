 ...
 */
public class Gen extends JCTree.Visitor implements CodeGen {
    ...
    protected Gen(Context context) {
        ...
        stringBufferType = null;
        stringBufferAppend = new LinkedHashMap<Type,Symbol>();
        accessDollar = names.
    ...
    public Item genExpr(JCTree tree, Type pt) {
        ...
        try {
            if(tree instanceof JCArgExpression)
                tree=((JCArgExpression)tree).exp1;
    ...
    //where
        ...
        void genTry(JCTree body, List<JCCatch> catchers, Env<GenContext> env) {
            ...
            if (hasFinalizer) {
                ...
                // start off with exception on stack
                int catchallpc = code.entryPoint(stateTry, null);
                ...
                if (env.info.cont != null) {
                    ...
                    // Save return address.
                    LocalItem retVar = makeTemp(null);
                    retVar.store();
...
//ALEX
            public void visitDomaionDef(JCDomainDecl tree) {}
            public void visitDoLoop(JCDoWhileLoop tree)
