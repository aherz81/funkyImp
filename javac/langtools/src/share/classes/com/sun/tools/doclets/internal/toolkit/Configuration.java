...
public abstract class Configuration {
    ...
    public Configuration() {
        ...
        excludedDocFileDirs = new LinkedHashSet<String>();
        excludedQualifiers = new LinkedHashSet<String>();
    }
    ...
    private void initPackageArray() {
        Set<PackageDoc> set = new LinkedHashSet<PackageDoc>(Arrays.asList(root.specifiedPackages()));
