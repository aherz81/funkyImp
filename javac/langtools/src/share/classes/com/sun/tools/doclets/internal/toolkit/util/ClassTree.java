...
public class ClassTree {
    ...
    */
    private Map<ClassDoc,List<ClassDoc>> subclasses = new LinkedHashMap<ClassDoc,List<ClassDoc>>();
    ...
    */
    private Map<ClassDoc,List<ClassDoc>> subinterfaces = new LinkedHashMap<ClassDoc,List<ClassDoc>>();

    private List<ClassDoc> baseEnums = new ArrayList<ClassDoc>();
    private Map<ClassDoc,List<ClassDoc>> subEnums = new LinkedHashMap<ClassDoc,List<ClassDoc>>();

    private List<ClassDoc> baseAnnotationTypes = new ArrayList<ClassDoc>();
    private Map<ClassDoc,List<ClassDoc>> subAnnotationTypes = new LinkedHashMap<ClassDoc,List<ClassDoc>>();

    /**
    * Mapping for each Interface with classes who implement it.
    */
    private Map<ClassDoc,List<ClassDoc>> implementingclasses = new LinkedHashMap<ClassDoc,List<ClassDoc>>();
     ...
     *    get the "value" from the LinkedHashMap for this key Class
