...
public class Check {
     ...
     */
    public Map<Name,ClassSymbol> compiled = new LinkedHashMap<Name, ClassSymbol>();

	public Map<Name,DomainSymbol> compiledDom = new LinkedHashMap<Name, DomainSymbol>();
...
//where
    ...
    Type checkClassType(DiagnosticPosition pos, Type t) {
        if (t.tag != CLASS && t.tag != ERROR && t.tag != DOMAIN && t.tag!=ARRAY)
     ...
     *  @param t             The type to be checked.
     */
    Type checkClassTypeApply(DiagnosticPosition pos, Type t) {
        if (t.tag != CLASS && t.tag != ERROR && t.tag != DOMAIN && t.tag!=ARRAY)
            return typeTagError(pos,
                                diags.fragment("method.template.params"),
                                (t.tag == TYPEVAR)
                                ? diags.fragment("type.parameter", t)
                                : t);
        else
    ...
    long checkFlags(DiagnosticPosition pos, long flags, Symbol sym, JCTree tree) {
        ...
        case TYP:
            if (sym.isLocal()) {
                ...
                mask = ClassFlags|Flags.FOUT|Flags.NATIVE;
            }
 ...
 **************************************************************************/
    ...
    private Symbol firstIncompatibility(Type t1, Type t2, Type site) {
        Map<TypeSymbol,Type> interfaces1 = new LinkedHashMap<TypeSymbol,Type>();
        closure(t1, interfaces1);
        Map<TypeSymbol,Type> interfaces2;
        if (t1 == t2)
            interfaces2 = interfaces1;
        else
            closure(t2, interfaces1, interfaces2 = new LinkedHashMap<TypeSymbol,Type>());
    ...
    boolean checkCommonOverriderIn(Symbol s1, Symbol s2, Type site) {
        Map<TypeSymbol,Type> supertypes = new LinkedHashMap<TypeSymbol,Type>();
...
//where
    ...
    void checkClassBounds(DiagnosticPosition pos, Type type) {
        checkClassBounds(pos, new LinkedHashMap<TypeSymbol,Type>(), type);
    }
//where
 ...
 **************************************************************************/
    ...
    public void validateAnnotation(JCAnnotation a) {
        ...
        Set<Symbol> targets = new LinkedHashSet<Symbol>();
 ...
 **************************************************************************/
    ...
    void checkCyclicConstructors(JCClassDecl tree) {
        Map<Symbol,Symbol> callMap = new LinkedHashMap<Symbol, Symbol>();
 ...
 **************************************************************************/
    ...
    void checkEmptyIfExp(JCIfExp tree) {
        if (tree.thenpart.getTag() == JCTree.SKIP && tree.elsepart == null && lint.isEnabled(Lint.LintCategory.EMPTY))
            log.warning(tree.thenpart.pos(), "empty.if");
    }
