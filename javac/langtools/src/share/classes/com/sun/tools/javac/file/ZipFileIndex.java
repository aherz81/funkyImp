...
public class ZipFileIndex {
    ...
    private static Map<File, ZipFileIndex> zipFileIndexCache = new LinkedHashMap<File, ZipFileIndex>();
    ...
    private Map <String, SoftReference<RelativeDirectory>> relativeDirectoryCache =
            new LinkedHashMap<String, SoftReference<RelativeDirectory>>();
    ...
    public Set<RelativeDirectory> getAllDirectories() {
        ...
        try {
            ...
            if (allDirs == Collections.EMPTY_SET) {
                allDirs = new LinkedHashSet<RelativeDirectory>(directories.keySet());
            }
   ...
   */
    ...
    private boolean writeIndex() {
        ...
        try {
            ...
            Map<RelativeDirectory, Long> offsets = new LinkedHashMap<RelativeDirectory, Long>();
