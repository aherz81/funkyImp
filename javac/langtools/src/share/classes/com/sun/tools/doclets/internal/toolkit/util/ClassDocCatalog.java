 ...
 */
 ...
 public class ClassDocCatalog {
    ...
    private Map<String,Set<ClassDoc>> annotationTypes;
     ...
     private void init() {
         allClasses = new LinkedHashMap<String,Set<ClassDoc>>();
         ordinaryClasses = new LinkedHashMap<String,Set<ClassDoc>>();
         exceptions = new LinkedHashMap<String,Set<ClassDoc>>();
         enums = new LinkedHashMap<String,Set<ClassDoc>>();
         annotationTypes = new LinkedHashMap<String,Set<ClassDoc>>();
         errors = new LinkedHashMap<String,Set<ClassDoc>>();
         interfaces = new LinkedHashMap<String,Set<ClassDoc>>();
