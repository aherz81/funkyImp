...
public class Kinds {
    ...
    /** The kind of type symbols (classes, interfaces and type variables).
     */
    public final static int DOM = 1 << 5;
    ...
    public static final int ABSENT_DOM   = ERRONEOUS+9; // missing type
    ...
    public static KindName kindName(int kind) {
        ...
        case DOM: return KindName.DOMAIN;
        case DOM|TYP: return KindName.DOMAIN;
    ...
    public static EnumSet<KindName> kindNames(int kind) {
        ...
        if ((kind & DOM) != 0) kinds.add(KindName.DOMAIN);
