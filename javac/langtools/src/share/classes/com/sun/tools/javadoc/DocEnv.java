...
public class DocEnv {
    ...
    private Map<PackageSymbol, PackageDocImpl> packageMap =
            new LinkedHashMap<PackageSymbol, PackageDocImpl>();
    /**
    ...
    private Map<ClassSymbol, ClassDocImpl> classMap =
            new LinkedHashMap<ClassSymbol, ClassDocImpl>();
    /**
    ...
    private Map<VarSymbol, FieldDocImpl> fieldMap =
            new LinkedHashMap<VarSymbol, FieldDocImpl>();
    /**
    ...
    private Map<MethodSymbol, ExecutableMemberDocImpl> methodMap =
            new LinkedHashMap<MethodSymbol, ExecutableMemberDocImpl>();
    /**
...
//          new LinkedHashMap<ClassType, ParameterizedTypeImpl>();
    /**
     * Return the ParameterizedType of this instantiation.
//   * ### Could use Type.sameTypeAs() instead of equality matching in LinkedHashMap
