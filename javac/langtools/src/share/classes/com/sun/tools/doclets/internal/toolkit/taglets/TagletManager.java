...
public class TagletManager {
    ...
    public TagletManager(boolean nosince, boolean showversion,
        ...
        overridenStandardTags = new LinkedHashSet<String>();
        potentiallyConflictingTags = new LinkedHashSet<String>();
        standardTags = new LinkedHashSet<String>();
        standardTagsLowercase = new LinkedHashSet<String>();
        unseenCustomTags = new LinkedHashSet<String>();
