...
public class FilerImpl implements Filer {
    ...
    private LinkedHashSet<String> sourceFileNames = new LinkedHashSet<String>();

    // Names of newly created class files
    private LinkedHashSet<String> classFileNames  = new LinkedHashSet<String>();
    ...
    private FilerImpl(Context context) {
        ...
        wc = new LinkedHashSet<Flushable>();
