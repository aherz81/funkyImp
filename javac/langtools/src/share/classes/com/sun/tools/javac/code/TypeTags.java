...
public class TypeTags {
    ...
    public static final int BOOLEAN = DOUBLE+1;
       ...
       /** The tag of the basic type `group'.
     */
    public static final int GROUP = BOOLEAN+1;
       /** The tag of the basic type `group'.
     */
    public static final int THREAD = GROUP+1;

    /** The tag of the type `void'.
     */
    public static final int VOID = THREAD+1;
...
//ALEX
    /** The tag of all class and interface types.
     */
    public static final int DOMAIN = ARRAY+1;
    /** The tag of all (monomorphic) method types.
     */
    public static final int METHOD = DOMAIN+1;
