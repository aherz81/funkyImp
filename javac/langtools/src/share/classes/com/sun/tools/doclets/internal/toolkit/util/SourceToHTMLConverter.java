...
public class SourceToHTMLConverter {
    ...
    /**
     * Given an array of <code>Doc</code>s, add to the given <code>LinkedHashMap</code> the
     ...
     * @param hash the <code>LinkedHashMap</code> to add to.
     */
    protected static void addToHash(Doc[] docs, LinkedHashMap<Integer,String> hash) {
        if(docs == null) {
            return;
        }
