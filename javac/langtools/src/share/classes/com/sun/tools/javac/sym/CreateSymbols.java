...
import com.sun.tools.javac.jvm.LlvmClassWriter;
...
public class CreateSymbols extends AbstractProcessor {
    ...
    void createSymbols() throws IOException {
        ...
        Set<String> documented = new LinkedHashSet<String>();
        ...
        Set<String> hiddenPackages = new LinkedHashSet<String>();
        Set<String> crisp = new LinkedHashSet<String>();
        ...
        LlvmClassWriter writer = LlvmClassWriter.instance(task.getContext());
    ...
    void writeClass(final Pool pool, final ClassSymbol cs, final LlvmClassWriter writer)
        throws IOException
    {
        try {
            pool.reset();
