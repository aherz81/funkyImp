...
public class Group {
     ...
     */
    private Map<String,String> regExpGroupMap = new LinkedHashMap<String,String>();
     ...
     */
    private Map<String,String> pkgNameGroupMap = new LinkedHashMap<String,String>();
    ...
    public Map<String,List<PackageDoc>> groupPackages(PackageDoc[] packages) {
        Map<String,List<PackageDoc>> groupPackageMap = new LinkedHashMap<String,List<PackageDoc>>();
