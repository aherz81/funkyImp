...
public interface Tree {
    ...
    public enum Kind {
        ...
        /**
         * Used for instances of {@link WhereTree}.
         */
        WHERE(WhereTree.class),
         ...
         * Used for instances of {@link WhereTree}.
         */
        SELECTCOND(SelectCondTree.class),

        /**
         * Used for instances of {@link WhereTree}.
         */
        SELECT(SelectTree.class),

        /**
         * Used for instances of {@link WhereTree}.
         */
        CASEEEXP(CaseExpTree.class),
        ...
        /**
         * Used for instances of {@link DomainTree}.
         */
        DOMAIN(DomainTree.class),

        /**
         * Used for instances of {@link DomainTree}.
         */
        DOMITER(DomIterTree.class),

        /**
         * Used for instances of {@link ClassTree}.
         */
        ARGEXPRESSION(ArgExpressionTree.class),
...
//ALEX:
        /**
         * Used for instances of {@link DomParameterTree}.
         */
        DOM_PARAMETER(DomParameterTree.class),

        /**
         * Used for instances of {@link DomParameterTree}.
         */
        CT_PROPERTY(CTPropertyTree.class),

        /**
         * Used for instances of {@link DomParameterTree}.
         */
        DOM_INSTANCE(DomInstanceTree.class),

		/**
         * Used for instances of {@link DomParameterTree}.
         */
        DOM_PARENT(DomParentTree.class),

        /**
         * Used for instances of {@link DomUsageTree}.
         */
		DOM_USAGE(DomUsageTree.class),

        /**
         * Used for instances of {@link DomConstraintValueTree}.
         */
        DOM_CONSTRAINT_VALUE(DomConstraintValueTree.class),

        /**
         * Used for instances of {@link DomConstraintValueTree}.
         */
        DOM_CONSTRAINT(DomConstraintTree.class),
        ...
        /**
         * Used for instances of {@link LiteralTree} representing
         * a character literal expression of type {@code group}.
         */
        GROUP_LITERAL(LiteralTree.class),
