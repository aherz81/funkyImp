...
public interface JavaFileObject extends FileObject {
    ...
    enum Kind {
        ...
        /**
         * Source files written in the Funky programming language.  For
         * example, regular files ending with {@code .funky}.
         */
        SOURCE2(".funky"),
        SOURCE3(".f"),
        
        /**
         * Kernel source files written in the OpenCL C programming language. For
         * example, regular files ending with {@code .cl}.
         * 
         */
        OPENCL_SOURCE(".cl"),
