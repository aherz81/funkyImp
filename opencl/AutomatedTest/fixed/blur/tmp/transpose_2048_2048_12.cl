...
float  __s_float_blur_2048_2048_float_p_int_int(global float *  __matrix, int  __x, int  __y);

//FUNCTION BODY DECLS
float  __s_float_blur_2048_2048_float_p_int_int(global float *  __matrix, int  __x, int  __y)
{
    if (__x<(1)||__y<(1)||__x==2048-(1)||__y==2048-(1))
...
__kernel void transpose_2048_2048_12(__global float *__matrix_0, int __matrix0_dim_0, int __matrix0_dim_1, int __new_array_0_dim_0, int __new_array_0_dim_1, __global float *__return_0)
{
    ...
    __return_0[__CUR_POS_0]=__s_float_blur_2048_2048_float_p_int_int(__matrix_0, __x_0, __y_0);
}