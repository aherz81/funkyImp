    ...
    extends TestCase
{
    ...
    public void _testVisitedImplementationPerformance()
    {
            ...
            numVertices *= 2)
        {
                ...
                connectednessFactor *= 2)
            {
                ...
                for (int seed = 0; seed < trialsPerConfiguration; seed++) { // test with random graph configurations
                    ...
                    DirectedAcyclicGraph<Long, DefaultEdge> arrayListDag =
                        new DirectedAcyclicGraph<Long, DefaultEdge>(
                            ...
                            null);
                    DirectedAcyclicGraph<Long, DefaultEdge> LinkedHashSetDag =
                        new DirectedAcyclicGraph<Long, DefaultEdge>(
                            DefaultEdge.class,
                            new DirectedAcyclicGraph.VisitedLinkedHashSetImpl(),
                            null);
                    ...
                    for (Long vertex : sourceGraph.vertexSet()) {
                        LinkedHashSetDag.addVertex(vertex);
                    }
                    ...
                    for (DefaultEdge edge : sourceGraph.edgeSet()) {
                        ...
                        try {
                            LinkedHashSetDag.addDagEdge(edgeSource, edgeTarget);
                        } catch (DirectedAcyclicGraph.CycleFoundException e) {
                            // okay
                        }
                    }

                    LinkedHashSetDagTime += System.nanoTime() - LinkedHashSetStart;
                ...
                System.out.println(
                    "total LinkedHashSet time     =  " + LinkedHashSetDagTime + " ns");
                System.out.println(
        ...
        extends RandomGraphGenerator<V, E>
    {
            ...
            Map<String, V> namedVerticesMap)
        {
            ...
            Set<Integer> edgeGeneratorIds = new LinkedHashSet<Integer>();
