 ...
 * Contributor(s):   -
 *
 * $Id: BronKerboschCliqueFinderTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    extends TestCase
{
    ...
    public void testFindAll()
    {
        ...
        Set<Set<String>> expected = new LinkedHashSet<Set<String>>();
        ...
        Set<Set<String>> actual = new LinkedHashSet<Set<String>>(cliques);
