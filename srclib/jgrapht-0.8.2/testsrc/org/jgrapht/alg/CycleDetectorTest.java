 ...
 *
 * $Id: CycleDetectorTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    extends TestCase
{
    ...
    public void testDirectedWithCycle()
    {
        ...
        Set<String> cyclicSet = new LinkedHashSet<String>();
        cyclicSet.add(V1);
        cyclicSet.add(V2);
        cyclicSet.add(V3);
        cyclicSet.add(V4);

        Set<String> acyclicSet = new LinkedHashSet<String>();
        acyclicSet.add(V5);
        acyclicSet.add(V6);
        acyclicSet.add(V7);
