 ...
 *
 * $Id: ConnectivityInspectorTest.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    extends TestCase
{
    ...
    public void testStronglyConnected1()
    {
        ...
        Set<Set<String>> actualSets =
            new LinkedHashSet<Set<String>>(inspector.stronglyConnectedSets());
    ...
    public void testStronglyConnected4()
    {
        ...
        assertEquals(
            expected,
            new LinkedHashSet<Set<Integer>>(sc.stronglyConnectedSets()));
    }
}
