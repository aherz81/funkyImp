    ...
    extends SimpleGraph<UndirectedGraph<V, E>, DefaultEdge>
{
    ...
    private Set<V> cutpoints = new LinkedHashSet<V>();
    ...
    private Map<V, Set<UndirectedGraph<V, E>>> vertex2biconnectedSubgraphs =
        new LinkedHashMap<V, Set<UndirectedGraph<V, E>>>();

    private Map<V, UndirectedGraph<V, E>> vertex2block =
        new LinkedHashMap<V, UndirectedGraph<V, E>>();

    private Map<V, Integer> vertex2numOrder = new LinkedHashMap<V, Integer>();
    ...
    private void biconnectedComponentFinished(V s, V n)
    {
        ...
        Set<V> vertexComponent = new LinkedHashSet<V>();
        Set<BCGEdge> edgeComponent = new LinkedHashSet<BCGEdge>();
    ...
    private Set<UndirectedGraph<V, E>> getBiconnectedSubgraphs(V vertex)
    {
        ...
        if (biconnectedSubgraphs == null) {
            biconnectedSubgraphs = new LinkedHashSet<UndirectedGraph<V, E>>();
