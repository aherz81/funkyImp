 ...
 *
 * $Id: BellmanFordIterator.java 725 2010-11-26 01:24:28Z perfecthash $
 *
 * Changes
 * -------
    ...
    implements Iterator<List<V>>
{
        ...
        BellmanFordPathElement<V, E> data)
    {
        if (this.prevVertexData == null) {
            this.prevVertexData =
                new LinkedHashMap<V, BellmanFordPathElement<V, E>>();
        }
        ...
        BellmanFordPathElement<V, E> data)
    {
        if (this.vertexData == null) {
            this.vertexData = new LinkedHashMap<V, BellmanFordPathElement<V, E>>();
        }
