 ...
 *                   Christian Hammer
 *
 * $Id: ConnectivityInspector.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    implements GraphListener<V, E>
{
    ...
    public Set<V> connectedSetOf(V vertex)
    {
        ...
        if (connectedSet == null) {
            connectedSet = new LinkedHashSet<V>();
    ...
    {
        connectedSets = null;
        vertexToConnectedSet = new LinkedHashMap<V, Set<V>>();
    }
        ...
        extends TraversalListenerAdapter<V, E>
    {
        ...
        public void connectedComponentStarted(
            ConnectedComponentTraversalEvent e)
        {
            currentConnectedSet = new LinkedHashSet<V>();
        }
