 ...
 *
 * $Id: KShortestPathsIterator.java 725 2010-11-26 01:24:28Z perfecthash $
 *
 * Changes
 * -------
    ...
    implements Iterator<Set<V>>
{
        ...
        int maxSize)
    {
        ...
        this.seenDataContainer = new LinkedHashMap<V, RankingPathElementList<V, E>>();
        this.prevSeenDataContainer =
            new LinkedHashMap<V, RankingPathElementList<V, E>>();

        this.prevImprovedVertices = new LinkedHashSet<V>();
    }
    ...
    public Set<V> next()
    {
        ...
        if (hasNext()) {
            Set<V> improvedVertices = new LinkedHashSet<V>();
