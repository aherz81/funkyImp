 ...
 *
 * $Id: DirectedNeighborIndex.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
    ...
    implements GraphListener<V, E>
{
    ...
    Map<V, Neighbors<V, E>> predecessorMap = new LinkedHashMap<V, Neighbors<V, E>>();
    Map<V, Neighbors<V, E>> successorMap = new LinkedHashMap<V, Neighbors<V, E>>();
