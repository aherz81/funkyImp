 ...
 *
 * $Id: JGraphModelAdapter.java 725 2010-11-26 01:24:28Z perfecthash $
 *
 * Changes
 * -------
    ...
    extends DefaultGraphModel
{
     ...
     */
    final Set<GraphCell> jCellsBeingAdded = new LinkedHashSet<GraphCell>();
    final Set<GraphCell> jCellsBeingRemoved = new LinkedHashSet<GraphCell>();
    final Set<Object> jtElementsBeingAdded = new LinkedHashSet<Object>();
    final Set<Object> jtElementsBeingRemoved = new LinkedHashSet<Object>();
    ...
    private final Map<org.jgraph.graph.Edge, E> cellToEdge =
        new LinkedHashMap<org.jgraph.graph.Edge, E>();

    /**
     * Maps JGraph vertices to JGraphT vertices
     */
    private final Map<GraphCell, V> cellToVertex = new LinkedHashMap<GraphCell, V>();
    ...
    private final Map<E, org.jgraph.graph.Edge> edgeToCell =
        new LinkedHashMap<E, org.jgraph.graph.Edge>();

    /**
     * Maps JGraphT vertices to JGraph vertices
     */
    private final Map<V, GraphCell> vertexToCell = new LinkedHashMap<V, GraphCell>();
