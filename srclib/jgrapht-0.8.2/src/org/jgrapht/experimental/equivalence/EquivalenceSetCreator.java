 ...
 * Contributor(s):   -
 *
 * $Id: EquivalenceSetCreator.java 722 2010-11-24 06:22:07Z perfecthash $
 *
 * Changes
 * -------
 */
...
public class EquivalenceSetCreator<E, C>
{
        ...
        CC aContext)
    {
        return (createEqualityGroupOrderedArray(
            ...
            //
            // LinkedHashMap<Integer,List<EquivalenceSet<? super EE,? super CC>>> map
     ...
     * @param aEqComparator
     *
     * @return a LinkedHashMap with key=group hashcode , value = list of eq.groups
     * which match that hash. TODO hb 060208: Using an array for aElementsArray
     * causes problems with generics elsewhere - change to List?
     */
    private static <EE, CC> LinkedHashMap<Integer,
        List<EquivalenceSet<? super EE, ? super CC>>> createEqualityGroupMap(
        Collection<EE> elements,
        EquivalenceComparator<? super EE, ? super CC> aEqComparator,
        CC aComparatorContext)
    {
        LinkedHashMap<Integer, List<EquivalenceSet<? super EE, ? super CC>>> equalityGroupMap =
            new LinkedHashMap<Integer, List<EquivalenceSet<? super EE, ? super CC>>>(
                elements.size());
