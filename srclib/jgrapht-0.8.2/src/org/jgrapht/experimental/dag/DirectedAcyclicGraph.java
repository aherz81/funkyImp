    ...
    extends SimpleDirectedGraph<V, E>
{
        ...
        throws CycleFoundException
    {
        ...
        if (lb < ub) {
            Set<V> df = new LinkedHashSet<V>();
            Set<V> db = new LinkedHashSet<V>();
    ...
    /**
     * a dual LinkedHashMap implementation
     *
     * @author gilesp
     */
            ...
            TopoOrderMappingFactory<V>
    {
        ...
        private final Map<Integer, V> topoToVertex = new LinkedHashMap<Integer, V>();
        private final Map<V, Integer> vertexToTopo = new LinkedHashMap<V, Integer>();
     ...
     * to vertex mapping, and a LinkedHashMap for vertex to topological index mapping.
     *
     * @author gilesp
     */
     ...
     * be more memory intensive than the LinkedHashSet implementation, and unlike the
     ...
     * @author gilesp
     */
    public static class VisitedLinkedHashSetImpl
        implements Visited,
            VisitedFactory
    {
        /**
        ...
        private final Set<Integer> visited = new LinkedHashSet<Integer>();
