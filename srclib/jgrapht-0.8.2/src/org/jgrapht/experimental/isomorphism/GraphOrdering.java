 ...
 * Contributor(s):   -
 *
 * $Id: GraphOrdering.java 725 2010-11-26 01:24:28Z perfecthash $
 *
 * Changes
 * -------
 */
...
public class GraphOrdering<V, E>
{
    ...
    /**
     * Holds a LinkedHashSet of all LabelsGraph of the graph.
     */
    ...
    private void init(Graph<V, E> g, Set<V> vertexSet, Set<E> edgeSet)
    {
        ...
        this.mapVertexToOrder = new LinkedHashMap<V, Integer>(vertexSet.size());
        ...
        this.labelsEdgesSet = new LinkedHashSet<LabelsEdge>(edgeSet.size());
        for (E edge : edgeSet) {
