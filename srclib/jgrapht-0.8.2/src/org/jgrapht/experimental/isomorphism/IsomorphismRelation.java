 ...
 * Contributor(s):   -
 *
 * $Id: IsomorphismRelation.java 645 2008-09-30 19:44:48Z perfecthash $
 *
 * Changes
 * -------
 */
    ...
    implements GraphMapping<V, E>
{
    ...
    private void initGraphMapping()
    {
        ...
        Map<V, V> g1ToG2 = new LinkedHashMap<V, V>(mapSize);
        Map<V, V> g2ToG1 = new LinkedHashMap<V, V>(mapSize);
