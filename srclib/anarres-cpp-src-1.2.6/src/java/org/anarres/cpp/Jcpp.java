...
public class Jcpp {
	...
	public static CharSequence Process(String[] args) throws Exception {
		return (new Jcpp()).run(args);
	}

	public CharSequence run(String[] args) throws Exception {
		Option[]opts = OPTS;
    ...
    String output = new String();
		...
		pp.setListener(new JavacPreprocessorListener());
...
//		try {
        ...
        output=output.concat(tok.getText());
			}
/*
		}
		catch (Exception e) {
