...
/* Source tokens */
		...
		if (expr_token != null)
			throw new InternalException(
					"Cannot unget two expression tokens."
						,true,source.getName(),tok.getLine(),tok.getColumn());
		expr_token = tok;
	}
	...
	private final Token _token()
        ...
        case DOMAIN:
				...
				default:
            tok.toString();
          throw new InternalException("Bad token "+tok.toString(),true,source.getName(),tok.getLine(),tok.getColumn());
					// break;
