...
#include "../barvinok-0.35/isl_obj_list.h"
#include "../barvinok-0.35/isl_obj_str.h"
#include <barvinok/isl.h>
#include <barvinok/options.h>
#include "../barvinok-0.35/lattice_width.h"

#include "ibarvinok.h"

//#include <com_sun_tools_javac_ibarvinok_ibarvinok.h>
...
#ifdef HAVE_CLOOG
struct clast_stmt *map_codegen(void *arg)
{
	isl_space *dim;
...
//	options->compilable = 1;
	...
	clast_pprint(tmp, stmt, 0, options);
...
struct clast_stmt *set_codegen(void *arg)
{
	isl_space *dim;
...
void error_dump(int doit)
{
	isl_set_error_dump(doit);
	dump_errors=doit;
}
