...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libibarvinok.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libibarvinok.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC

${OBJECTDIR}/ibarvinoc.o: ibarvinoc.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/ibarvinoc.o ibarvinoc.c

${OBJECTDIR}/isl_obj_list.o: isl_obj_list.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/isl_obj_list.o isl_obj_list.c

${OBJECTDIR}/isl_obj_str.o: isl_obj_str.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/isl_obj_str.o isl_obj_str.c
