...
class union_map:
    ...
    def foreach_map(self, arg1):
        ...
        return res
    def card(self):
        res = isl.isl_union_map_card(isl.isl_union_map_copy(self.ptr))
        return union_pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_union_map_card.restype = c_void_p
...
class map(union_map):
    ...
    def foreach_basic_map(self, arg1):
        ...
        return res
    def card(self):
        res = isl.isl_map_card(isl.isl_map_copy(self.ptr))
        return pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_map_card.restype = c_void_p
...
class basic_map(map):
    ...
    def gist(self, arg1):
        ...
        return basic_map(ctx=self.ctx, ptr=res)
    def card(self):
        res = isl.isl_basic_map_card(isl.isl_basic_map_copy(self.ptr))
        return pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_basic_map_card.restype = c_void_p
...
class union_set:
    ...
    def foreach_set(self, arg1):
        ...
        return res
    def card(self):
        res = isl.isl_union_set_card(isl.isl_union_set_copy(self.ptr))
        return union_pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_union_set_card.restype = c_void_p
...
class set(union_set):
    ...
    def flatten(self):
        ...
        return set(ctx=self.ctx, ptr=res)
    def card(self):
        res = isl.isl_set_card(isl.isl_set_copy(self.ptr))
        return pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_set_card.restype = c_void_p
...
class basic_set(set):
    ...
    def flatten(self):
        ...
        return basic_set(ctx=self.ctx, ptr=res)
    def card(self):
        res = isl.isl_basic_set_card(isl.isl_basic_set_copy(self.ptr))
        return pw_qpolynomial(ctx=self.ctx, ptr=res)
...
isl.isl_basic_set_card.restype = c_void_p
...
class pw_qpolynomial:
    def __init__(self, *args, **keywords):
        ...
        if len(args) == 1 and type(args[0]) == str:
            self.ctx = Context.getDefaultInstance()
            self.ptr = isl.isl_pw_qpolynomial_read_from_str(self.ctx, args[0])
            return
        raise Error
    def __del__(self):
        if hasattr(self, 'ptr'):
...
class union_pw_qpolynomial:
    def __init__(self, *args, **keywords):
        ...
        if len(args) == 1 and type(args[0]) == str:
            self.ctx = Context.getDefaultInstance()
            self.ptr = isl.isl_union_pw_qpolynomial_read_from_str(self.ctx, args[0])
            return
        raise Error
    def __del__(self):
        if hasattr(self, 'ptr'):
