...
uint8 buffer[16*MAX_CHUNKS] __aligned__;

// lookup for SSE
uint8 POPCOUNT_4bit[16] __aligned__ = {
	/* 0 */ 0,
	/* 1 */ 1,
	/* 2 */ 1,
	/* 3 */ 2,
...
// uint32 instead of uint8, to avoid zero-extend
uint32 POPCOUNT_8bit[256] __aligned__ = {
	/* 0 */ 0, /* 1 */ 1, /* 2 */ 1, /* 3 */ 2,
	/* 4 */ 1, /* 5 */ 2, /* 6 */ 2, /* 7 */ 3,
	/* 8 */ 1, /* 9 */ 2, /* a */ 2, /* b */ 3,
	/* c */ 2, /* d */ 3, /* e */ 3, /* f */ 4,
...
uint32 ssse3_popcount2(uint8* buffer, int chunks16) {
