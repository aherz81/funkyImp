...
class B: public boehmgc::gc, public A {public:
    /* A collectable class. */
...
class C: public boehmgc::gc_cleanup, public A {public:
...
class D: public boehmgc::gc {public:
...
class E: public boehmgc::gc_cleanup {public:
